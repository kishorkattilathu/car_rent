	...
	<div class="w3-services py-5">
		<div class="container py-lg-4">
			...
			<div class="row w3-services-grids">
        		<?php
        		$select="SELECT * FROM car_sale WHERE brand_id='$brandid' AND car_sold='Pending'";
        		...
        		while ($fetch=mysqli_fetch_array($execute))
        	{
				...
				<div class="col-lg-4 col-md-6 causes-grid" style="border-style: solid;border-color:grey;border-width: 0.1px">
					<div class="causes-grid-info">
						<a href="single_blog.php?id=<?php echo $fetch['car_sale_id'] ?>"><img src="sale_car_images/<?php echo $fetch['photo'] ?>" class="img-fuild" alt=""></a>
						<a href="#" class="cause-title-wrap">
							<h4 class="cause-title"><?php echo $fetch['name']?>
							</h4>
