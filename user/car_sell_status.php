...
<div class="row w3-services-grids">
          <?php
        include('../connect.php');
        $select="SELECT * FROM booking inner join car_sale on booking.car_sale_id=car_sale.car_sale_id where owner_email='$mail' and booking.booking_status='Pending'";
      ...
      <div class="row w3-services-grids">
        ...
        <div class="col-lg-15 col-md-15causes-grid">
          <div class="causes-grid-info">
            ...
            <a href="#" class="cause-title-wrap">
              ...
              <h6 class="cause-title">Car Name : <?php echo $fetch['name']?></h6>
              <h6 class="cause-title">Customer Email : <?php echo $fetch['customer_email']?></h6>
            ...
            <a href="approve.php?id=<?=$fetch['booking_id']?>">
              <button class="btn btn-success">Approve</button>
            </a>
          <a href="reject.php?id=<?=$fetch['booking_id']?>">
