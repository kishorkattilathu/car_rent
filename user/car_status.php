 ...
 <section class="w3l-about-breadcrumb position-relative text-center">
	...
	<div class="w3-services py-5">
		<div class="container py-lg-4">
       	...
       	<?php
       		include ('../connect.php');
       		$select="SELECT * FROM booking inner join car_sale on booking.car_sale_id=car_sale.car_sale_id inner join user on booking.customer_email=user.email where owner_email='$mail' and booking_status='Approved'";
       	...
       	?>
        		...
        		<div class="col-lg-4 col-md-6 causes-grid"style="border-style: solid;border-color:grey;border-width: 0.1px;">
					<div class="causes-grid-info">
						...
						<a href="#" class="cause-title-wrap"><br><br>
							<h6 class="cause-title">Customer Name:<?php echo $fetch['username']?></h6><br>
							<h6 class="cause-title">Email: <?php echo $fetch['email']?></h6><br>
							<h6 class="cause-title">Car Name:<?=$fetch['name']?>
							</h6><br>
							<h6 class="cause-title">Booking Status:<?=$fetch['booking_status']?>
							</h6><br>
							<h6 class="cause-title">Payment-Status:<?=$fetch['payment_status']?>
							</h6><br>
				...
				<?php
					if ($fetch['payment_status']=='Token_Paid') 
					{
						?><a href="sold.php?id=<?=$fetch['booking_id']?>&sale_id=<?=$fetch['car_sale_id']?>"><button class="btn btn-success">SOLD</button></a>   <?php
					}
